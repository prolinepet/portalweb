  ...
  try {
    ...
    const complaints = await prisma.complaint.findMany({
      ...
      select: {
        ...
        type: true,
        phase: true,
        sacSgqProcess: { select: { id: true, code: true, description: true } },
        sacSgqPhase: { select: { id: true, code: true, description: true } },
        responsibleUser: { select: { id: true, name: true, abbrevName: true } },
        dateSac: true,
        dateReceived: true,
        createdAt: true,
      },
